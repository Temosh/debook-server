...
CREATE TABLE IF NOT EXISTS `debook_db`.`request` (
  ...
  INDEX `fk_request_source_event_idx` (`source_event_id` ASC),
  INDEX `fk_request_target_event_idx` (`target_event_id` ASC),
  INDEX `fk_request_previous_request_idx` (`previous_request_id` ASC),
  CONSTRAINT `fk_request_source_event`
    FOREIGN KEY (`source_event_id`)
    REFERENCES `debook_db`.`event` (`event_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_request_target_event`
...
-- -----------------------------------------------------
-- Table `debook_db`.`timestamps`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `debook_db`.`timestamps` ;

CREATE TABLE IF NOT EXISTS `debook_db`.`timestamps` (
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` TIMESTAMP NULL);


-- -----------------------------------------------------
-- Table `debook_db`.`timestamps_1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `debook_db`.`timestamps_1` ;

CREATE TABLE IF NOT EXISTS `debook_db`.`timestamps_1` (
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` TIMESTAMP NULL);
